/**
 * Dark theme configuration for Semiconspace Admin Dashboard
 */
...
const darkColors = {
  ...
  text: {
    main: "#e0e0e0", // Light text for dark background
    focus: "#f5f5f5",
  },
  dark: {
    main: "#e0e0e0", // Inverted for dark theme
    focus: "#f5f5f5",
  },
  light: {
    main: "#2c3144", // Darker shade for "light" elements in dark mode
    focus: "#2c3144",
  },
  white: {
    main: "#1a1f2e", // Using dark color instead of white
    focus: "#1a1f2e",
  },
  black: {
    light: "#f5f5f5",
    main: "#ffffff", // Inverted for dark theme
    focus: "#ffffff",
  },
  // Keep the green accent color
  info: {
    main: "#22c55e", // Keep the same green
    focus: "#16a34a",
  },
  gradients: {
    ...colors.gradients,
